<footer id="colophon" class="site-footer">
    ...
    <?php else: ?>
        <div class="footer-logo"><img src="<?php echo esc_url(get_theme_file_uri('/assets/static/footer_logo.svg')); ?>" alt="Footer Logo (Fallback)"></div>
    <?php endif ?>
    ...
    <div class="site-footer__credits">
        ...
        <a href="<?php echo esc_url($footer_credits_url); ?>">
            ...
            <?php else: ?>
                <img src="<?php echo esc_url(get_theme_file_uri('/assets/static/ami_logo.svg')); ?>" alt="Footer Credits Logo (Fallback)">
            <?php endif ?>
        </a>
