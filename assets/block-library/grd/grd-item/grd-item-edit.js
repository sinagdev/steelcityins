  ...
  return (
    <>
      <InspectorControls group="styles">
        <PanelBody title={__("Column Spanning", "sinag")}>
          <TextControlList
            title={__("Span Columns", "sinag")}
            attributeName="span"
        ...
        <PanelBody
          title={__("Vertical Alignment", "sinag")}
          initialOpen={false}
        >
          <ButtonGroup>
            {[
              ...
              return (
                <Button
                  ...
                  onClick={() => setAttributes({ vAlign: opt.value })}
                  icon={
                    <Icon
                      icon={opt.icon}
                      style={{
        ...
        <PanelBody
          title={__("Advanced Columns & Rows", "sinag")}
          initialOpen={false}
        >
          <TextControlList
            title={__("Force Column", "sinag")}
            attributeName="col"
            attributes={attributes}
            setAttributes={setAttributes}
          />
          <TextControlList
            title={__("Force Row", "sinag")}
            attributeName="row"
            attributes={attributes}
            setAttributes={setAttributes}
          />
          <TextControlList
            title={__("Span Rows", "sinag")}
