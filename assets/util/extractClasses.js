 ...
 *
 * You can begin attribute names with sinagClassName
 * (e.g. sinagClassNameSpacing) to automatically have this function add
...
const extractClasses = (attributes) => {
	...
	for (const [key, value] of Object.entries(attributes)) {
		if (key.startsWith('sinagClassName') && value.length) {
